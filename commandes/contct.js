...
𝐂𝐇𝐔𝐆𝐀 𝐗𝐌𝐃 ᴏᴡɴᴇʀ sᴀʏs ᴍᴏsᴛ ᴏғ ᴜᴘᴅᴀᴛᴇs ᴀʀᴇ ᴀʀᴏᴜɴᴅ ᴛʜᴇ ᴄᴏʀɴᴇʀ... ʏᴏᴜ ᴡɪʟʟ ᴇɴᴊᴏʏ ᴍᴏʀᴇ ᴄᴏᴍᴍᴀɴᴅs ᴀs ʜᴇ ᴀᴅᴅs ᴛʜᴇᴍ...
...
zokou({ nomCom: 'channel1',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`tap here to join my second channel https://whatsapp.com/channel/0029Vb3eLRU3QxS5CZHI131x`) 
...
zokou({ nomCom: 'chugastan',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*_CHUGA-XMD is running...... Love it_*`) 
...
zokou({ nomCom: 'me',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*check the developer via https://wa.me/c/255622286792*`) 
